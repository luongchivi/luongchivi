...
g_host = ""
g_user_name = ""  # SSH connection details
...
def get_target_details():
    ...
    # g_host = '192.168.92.132'
    # g_user_name = 'msfadmin'
    # g_word_list = 'D:\eLearn\Capstone Project\passwords.txt'
...
def connect_ssh(password):
    global g_host, g_user_name, g_word_list, client_ssh
